package discussion.forum.activity;
...
public class UserActivity {
    ...
    public void deleteQuestion(UserActivity userActivity, User user) throws NumberFormatException, IOException {
        ...
        } else if (user.getUserRole() == UserRole.MODERATOR) { // Write else if condition to check if the user is a moderator
        ...
        } else { // Write else if condition to check if the user is a regular user
